 ...
 * @returns
 */
export async function loadImageAsBlob(url, returnGifAsStillImage) {
  const image = await loadImage(url, returnGifAsStillImage);
  if (image) {
 ...
 */
export async function loadImage(url, returnGifAsStillImage = false) {
  try {
